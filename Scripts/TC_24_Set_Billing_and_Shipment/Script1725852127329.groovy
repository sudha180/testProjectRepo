...
//GetAddress_Response = WS.sendRequest(findTestObject('TotalPlay-Shop/Postman/Address/Get Customer Address', [('URL') : GlobalVariable.URL, ('SITEID') : GlobalVariable.SITEID
//            , ('sla_customerId') : GlobalVariable.sla_customerId]))
