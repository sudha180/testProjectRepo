...
UpdateAddress = WS.sendRequest(findTestObject('TotalPlay-Food/update customer address', [('URL') : GlobalVariable.URL, ('CustomerID') : GlobalVariable.sla_customerId]))

WS.verifyResponseStatusCode(UpdateAddress, 200)
...
addresses_postalCode = 'data[0].postal_code'

String PostalCode = WS.getElementPropertyValue(GetAddress, addresses_postalCode)
