...
CustomKeywords.'totalplay.Common.verifyPropertyExist'(SetPayment_instruments,	payment_instruments_payment_card)
CustomKeywords.'totalplay.Common.verifyPropertyValueExist'(SetPayment_instruments,	payment_instruments_payment_card_card_type)
CustomKeywords.'totalplay.Common.verifyPropertyValueExist'(SetPayment_instruments,	payment_instruments_payment_card_type)
CustomKeywords.'totalplay.Common.getBooleanValueofObject'(SetPayment_instruments,	payment_instruments_payment_card_credit_card_expired)
CustomKeywords.'totalplay.Common.getNumValueofObject'(SetPayment_instruments,	payment_instruments_payment_card_expiration_month)
CustomKeywords.'totalplay.Common.getNumValueofObject'(SetPayment_instruments,	payment_instruments_payment_card_expiration_year)
CustomKeywords.'totalplay.Common.verifyPropertyValueExist'(SetPayment_instruments,	payment_instruments_payment_card_holder)
...
CustomKeywords.'totalplay.Common.getNumValueofObject'(SetPayment_instruments,	product_items_price_after_order_discount)
...
CustomKeywords.'totalplay.Common.getNumValueofObject'(SetPayment_instruments,	shipments_adjusted_shipping_total_tax)
...
CustomKeywords.'totalplay.Common.getDecimalValueofObject'(SetPayment_instruments,	shipments_product_sub_total)
...
CustomKeywords.'totalplay.Common.getDecimalValueofObject'(SetPayment_instruments,	shipments_shipment_total)
...
CustomKeywords.'totalplay.Common.verifyPropertyValueExist'(SetPayment_instruments,	shipments_shipping_method_name)
...
CustomKeywords.'totalplay.Common.verifyPropertyExist'(SetPayment_instruments, payment_instruments_0_payment_card__type)
CustomKeywords.'totalplay.Common.verifyPropertyValueExist'(SetPayment_instruments, payment_instruments_0_payment_card__type)

CustomKeywords.'totalplay.Common.verifyPropertyExist'(SetPayment_instruments, payment_instruments_0_payment_card_card_type)
CustomKeywords.'totalplay.Common.verifyPropertyValueExist'(SetPayment_instruments, payment_instruments_0_payment_card_card_type)

CustomKeywords.'totalplay.Common.getBooleanValueofObject'(SetPayment_instruments, payment_instruments_0_payment_card_credit_card_expired)
CustomKeywords.'totalplay.Common.getNumValueofObject'(SetPayment_instruments, payment_instruments_0_payment_card_expiration_month)
CustomKeywords.'totalplay.Common.getNumValueofObject'(SetPayment_instruments, payment_instruments_0_payment_card_expiration_year)

CustomKeywords.'totalplay.Common.verifyPropertyExist'(SetPayment_instruments, payment_instruments_0_payment_card_holder)
CustomKeywords.'totalplay.Common.verifyPropertyValueExist'(SetPayment_instruments, payment_instruments_0_payment_card_holder)
