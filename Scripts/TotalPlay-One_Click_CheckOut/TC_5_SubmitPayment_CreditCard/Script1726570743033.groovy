...
SubmitPayment = WS.sendRequest(findTestObject('One_Click_CheckOut/temporary basket/submit payment temporary basket credit card', [('URL') : GlobalVariable.URL
            , ('SITEID') : GlobalVariable.SITEID, ('temporary_basket_id') : GlobalVariable.temporary_basket_id, ('temporary_basket_order_total') : GlobalVariable.temporary_basket_order_total]))
...
CustomKeywords.'totalplay.Common.verifyPropertyExist'(SubmitPayment, payment_instruments_0_payment_card__type)
CustomKeywords.'totalplay.Common.verifyPropertyValueExist'(SubmitPayment, payment_instruments_0_payment_card__type)

CustomKeywords.'totalplay.Common.verifyPropertyExist'(SubmitPayment, payment_instruments_0_payment_card_card_type)
CustomKeywords.'totalplay.Common.verifyPropertyValueExist'(SubmitPayment, payment_instruments_0_payment_card_card_type)

CustomKeywords.'totalplay.Common.getBooleanValueofObject'(SubmitPayment, payment_instruments_0_payment_card_credit_card_expired)
